...
public class TargetManager : MonoBehaviour
{
    ...
    public void targetShow(GameObject old, GameObject target)       //Used for toggling targets between individual game objects. Will make sure the new target 
    {
        ...
        pos.LookAt(cam.transform);                           //NOTE: The number may need to be altered a little bit for boss fights assuming the animations end up clipping through the object
    }
